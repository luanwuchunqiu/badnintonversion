package com.myweather.app.badmintonversion.view.picker.wheelpicker.picker;
...
import com.myweather.app.badmintonversion.view.picker.common.util.DateUtils;
import com.myweather.app.badmintonversion.view.picker.common.util.LogUtils;
...
public class DateTimePicker extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
            dayView.setLayoutParams(new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
            dayView.setItems(days, selectedDayIndex);
        ...
        if (timeMode != NONE) {
            hourView.setLayoutParams(new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
